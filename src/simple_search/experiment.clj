...
(defn -main
  ...
  (print-experimental-results
   (run-experiment
    [(with-meta
       #(core/hill-climber %1 core/flip-choices %2) ; max-tries as %2, problem as %1
       {:label "hill_climber"})
     (with-meta
       #(core/random-restart %1 core/flip-choices %2 10)
       {:label "hill_climber_random_restart"})
     (with-meta
       #(core/random-search %1 %2)
      {:label "random_search"})
     ]
    (map get-labelled-problem
         ["knapPI_11_20_1000_4" "knapPI_13_20_1000_4" "knapPI_16_20_1000_4" "knapPI_11_200_1000_4" "knapPI_13_200_1000_4" "knapPI_16_200_1000_4"])
